...
# Load user credentials from a JSON file (persistent storage)
def load_users():
    try:
...
if not st.session_state["logged_in"]:
    ...
    if menu == "⚡ Energy Consumption Prediction":
        ...
        data = pd.read_csv(r"D:\My Work\Infosys Spring Board AI Intern\Energy Consumption Prediction\Dataset\Malmi_office_building_hourly.csv")
        ...
        data = pd.read_csv(r"D:\My Work\Infosys Spring Board AI Intern\Energy Consumption Prediction\Dataset\Final_dataset.csv")
